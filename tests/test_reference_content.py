...
PAGES = {
    "docs/weconduct/troubleshooting/index.md": ("weconduct", "0.9.1", "weconduct:troubleshooting:index"),
    "docs/weconduct/troubleshooting/project-and-startup.md": ("weconduct", "0.9.1", "weconduct:troubleshooting:project-and-startup"),
    "docs/weconduct/troubleshooting/graph-validation.md": ("weconduct", "0.9.1", "weconduct:troubleshooting:graph-validation"),
    "docs/weconduct/troubleshooting/runtime-and-debug.md": ("weconduct", "0.9.1", "weconduct:troubleshooting:runtime-and-debug"),
    "docs/weconduct/troubleshooting/browser-and-network.md": ("weconduct", "0.9.1", "weconduct:troubleshooting:browser-and-network"),
    "docs/weconduct/troubleshooting/files-python-and-packages.md": ("weconduct", "0.9.1", "weconduct:troubleshooting:files-python-and-packages"),
    "docs/weconduct/reference/keyboard-shortcuts.md": ("weconduct", "0.9.1", "weconduct:reference:keyboard-shortcuts"),
    "docs/weconduct/reference/project-format.md": ("weconduct", "0.9.1", "weconduct:reference:project-format"),
    "docs/weconduct/reference/variable-syntax.md": ("weconduct", "0.9.1", "weconduct:reference:variable-syntax"),
    "docs/weconduct/reference/glossary.md": ("weconduct", "0.9.1", "weconduct:reference:glossary"),
}
