...
const PARAM_TEMPLATES: Record<string, ParamField[]> = {
  ...
  'message.emit': [{ key: 'message', type: 'string', label: '消息' }, { key: 'severity', type: 'string', label: '等级', options: ['info', 'warning', 'error', 'fatal'] }],
...
const OBJECT_MAP_KEYS = new Set(['initial_variables', 'variables', 'inputs', 'outputs', 'local_storage', 'headers', 'query', 'multipart_fields', 'required_headers', 'json_path_equals'])
