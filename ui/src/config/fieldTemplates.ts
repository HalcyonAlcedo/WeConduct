...
export const PARAM_TEMPLATES: Record<string, FieldTemplate[]> = {
  ...
  'network.graphql_subscription': [{ key: 'context_strategy', type: 'string', options: ['inherit', 'new', 'anonymous', 'fork', 'switch', 'reset'] }, { key: 'action', type: 'string', options: ['connect', 'next_event', 'receive', 'unsubscribe', 'cancel', 'close'] }, { key: 'connection_id', type: 'string' }, { key: 'endpoint', type: 'string' }, { key: 'query', type: 'code' }, { key: 'operation_name', type: 'string' }, { key: 'variables', type: 'object-map' }, { key: 'headers', type: 'object-map' }, { key: 'subprotocol', type: 'string', options: ['graphql-transport-ws', 'graphql-ws'] }, { key: 'timeout_seconds', type: 'number' }, { key: 'max_queue_size', type: 'number' }, { key: 'max_reconnect_attempts', type: 'number' }, { key: 'reconnect_delay_seconds', type: 'number' }, { key: 'reconnect_max_delay_seconds', type: 'number' }, { key: 'backpressure_policy', type: 'string', options: ['fail_stream', 'drop_oldest', 'drop_newest', 'close_connection'] }, { key: 'auth', type: 'json' }, { key: 'tls', type: 'json' }, { key: 'proxy', type: 'json' }, { key: 'base_url', type: 'string' }, { key: 'response_limits', type: 'json' }],
  'network.sse_connect': [{ key: 'context_strategy', type: 'string', options: ['inherit', 'new', 'anonymous', 'fork', 'switch', 'reset'] }, { key: 'action', type: 'string', options: ['connect', 'receive', 'close'] }, { key: 'connection_id', type: 'string' }, { key: 'url', type: 'string' }, { key: 'headers', type: 'object-map' }, { key: 'query', type: 'object-map' }, { key: 'timeout_seconds', type: 'number' }, { key: 'max_queue_size', type: 'number' }, { key: 'max_reconnect_attempts', type: 'number' }, { key: 'reconnect_delay_seconds', type: 'number' }, { key: 'reconnect_max_delay_seconds', type: 'number' }, { key: 'auth', type: 'json' }, { key: 'tls', type: 'json' }, { key: 'proxy', type: 'json' }, { key: 'base_url', type: 'string' }, { key: 'response_limits', type: 'json' }],
  'network.websocket_connect': [{ key: 'context_strategy', type: 'string', options: ['inherit', 'new', 'anonymous', 'fork', 'switch', 'reset'] }, { key: 'action', type: 'string', options: ['connect', 'send', 'receive', 'ping', 'close'] }, { key: 'connection_id', type: 'string' }, { key: 'url', type: 'string' }, { key: 'message', type: 'typed-value' }, { key: 'headers', type: 'object-map' }, { key: 'subprotocols', type: 'json' }, { key: 'timeout_seconds', type: 'number' }, { key: 'max_reconnect_attempts', type: 'number' }, { key: 'reconnect_delay_seconds', type: 'number' }, { key: 'reconnect_max_delay_seconds', type: 'number' }, { key: 'auth', type: 'json' }, { key: 'tls', type: 'json' }, { key: 'proxy', type: 'json' }, { key: 'base_url', type: 'string' }, { key: 'response_limits', type: 'json' }],
