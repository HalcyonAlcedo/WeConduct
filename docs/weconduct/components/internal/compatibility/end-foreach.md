...
该节点属于“兼容与内部节点”。实现类型为 `core_atomic`，运行展开角色为 `control:end_foreach`。
...
<weconduct-graph src="../../../../assets/graphs/components/internal/control-end-foreach.json" title="结束遍历配置示例">图示加载失败时，可阅读下方配置。</weconduct-graph>
