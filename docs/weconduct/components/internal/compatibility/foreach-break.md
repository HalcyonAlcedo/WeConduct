...
资源键：`control.foreach_break`　|　英文名：Foreach Break
## 功能说明
...
<weconduct-graph src="../../../../assets/graphs/components/internal/control-foreach-break.json" title="遍历中断配置示例">如果图示加载失败，可以查看下方的示例配置。</weconduct-graph>
