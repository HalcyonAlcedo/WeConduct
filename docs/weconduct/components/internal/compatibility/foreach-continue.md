...
product: weconduct
version: 0.8.1
doc_id: component:control.foreach_continue
---
...
该节点属于“兼容与内部节点”。实现类型为 `core_atomic`，运行展开角色为 `control:foreach_continue`。
...
<weconduct-graph src="../../../../assets/graphs/components/internal/control-foreach-continue.json" title="遍历继续配置示例">图示加载失败时，可阅读下方配置。</weconduct-graph>
