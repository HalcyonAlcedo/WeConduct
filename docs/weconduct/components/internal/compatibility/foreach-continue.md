...
资源键：`control.foreach_continue`　|　英文名：Foreach Continue
## 功能说明
...
<weconduct-graph src="../../../../assets/graphs/components/internal/control-foreach-continue.json" title="遍历继续配置示例">如果图示加载失败，可以查看下方的示例配置。</weconduct-graph>
