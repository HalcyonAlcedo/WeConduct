...
该节点属于“文本与 CSV 文件”。实现类型为 `未声明`，运行展开角色为 `action:read_csv_cell`。
...
<weconduct-graph src="../../../../assets/graphs/components/file/file-read-csv-cell.json" title="读取 CSV 单元格配置示例">图示加载失败时，可阅读下方配置。</weconduct-graph>
