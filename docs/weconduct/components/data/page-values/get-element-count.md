...
资源键：`data.get_element_count`　|　英文名：Get Element Count
## 功能说明
...
<weconduct-graph src="../../../../assets/graphs/components/data/data-get-element-count.json" title="读取元素数量配置示例">如果图示加载失败，可以查看下方的示例配置。</weconduct-graph>
