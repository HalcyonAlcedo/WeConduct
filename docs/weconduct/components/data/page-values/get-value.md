...
该节点属于“页面取值”。实现类型为 `core_atomic`，运行展开角色为 `action:get_value`。
...
<weconduct-graph src="../../../../assets/graphs/components/data/data-get-value.json" title="读取值配置示例">图示加载失败时，可阅读下方配置。</weconduct-graph>
