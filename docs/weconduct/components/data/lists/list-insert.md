...
该节点属于“列表处理”。实现类型为 `builtin_custom_component`，运行展开角色为 `action:list_insert`。
...
<weconduct-graph src="../../../../assets/graphs/components/data/data-list-insert.json" title="列表插入配置示例">图示加载失败时，可阅读下方配置。</weconduct-graph>
