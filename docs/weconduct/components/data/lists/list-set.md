...
product: weconduct
version: 0.9.0
doc_id: component:data.list_set
---

# 列表写入

资源键：`data.list_set`　|　英文名：List Set
## 功能说明
...
<weconduct-graph src="../../../../assets/graphs/components/data/data-list-set.json" title="列表写入配置示例">如果图示加载失败，可以查看下方的示例配置。</weconduct-graph>
