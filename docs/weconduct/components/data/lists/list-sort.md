...
product: weconduct
version: 0.9.1
doc_id: component:data.list_sort
---

# 列表排序

资源键：`data.list_sort`　|　英文名：List Sort
## 功能说明
...
<weconduct-graph src="../../../../assets/graphs/components/data/data-list-sort.json" title="列表排序配置示例">如果图示加载失败，可以查看下方的示例配置。</weconduct-graph>
