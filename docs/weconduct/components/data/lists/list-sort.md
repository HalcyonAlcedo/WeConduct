...
该节点属于“列表处理”。实现类型为 `builtin_custom_component`，运行展开角色为 `action:list_sort`。
...
<weconduct-graph src="../../../../assets/graphs/components/data/data-list-sort.json" title="列表排序配置示例">图示加载失败时，可阅读下方配置。</weconduct-graph>
