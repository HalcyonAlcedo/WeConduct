...
资源键：`data.list_remove`　|　英文名：List Remove
## 功能说明
...
<weconduct-graph src="../../../../assets/graphs/components/data/data-list-remove.json" title="列表移除配置示例">如果图示加载失败，可以查看下方的示例配置。</weconduct-graph>
