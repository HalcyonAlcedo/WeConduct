...
product: weconduct
version: 0.9.1
doc_id: component:data.list_extend
---

# 列表扩展

资源键：`data.list_extend`　|　英文名：List Extend
## 功能说明
...
输入端口：`in`、`in:items`。输出端口：`out`、`out:value`。对外影响：直接更新原列表变量。

## 使用示例

<weconduct-graph src="../../../../assets/graphs/components/data/data-list-extend.json" title="列表扩展配置示例">如果图示加载失败，可以查看下方的示例配置。</weconduct-graph>
