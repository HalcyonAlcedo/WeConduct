...
资源键：`data.create_list`　|　英文名：Create List
## 功能说明
...
<weconduct-graph src="../../../../assets/graphs/components/data/data-create-list.json" title="创建列表配置示例">如果图示加载失败，可以查看下方的示例配置。</weconduct-graph>
