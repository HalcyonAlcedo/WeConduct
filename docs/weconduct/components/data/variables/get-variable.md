...
该节点属于“变量读写”。实现类型为 `core_atomic`，运行展开角色为 `action:get_variable`。
...
<weconduct-graph src="../../../../assets/graphs/components/data/data-get-variable.json" title="读取变量配置示例">图示加载失败时，可阅读下方配置。</weconduct-graph>
