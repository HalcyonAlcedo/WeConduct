...
product: weconduct
version: 0.8.1
doc_id: component:data.increment_variable
---
...
该节点属于“变量读写”。实现类型为 `builtin_custom_component`，运行展开角色为 `action:increment_variable`。
...
<weconduct-graph src="../../../../assets/graphs/components/data/data-increment-variable.json" title="变量递增配置示例">图示加载失败时，可阅读下方配置。</weconduct-graph>
