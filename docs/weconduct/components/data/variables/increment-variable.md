...
资源键：`data.increment_variable`　|　英文名：Increment Variable
## 功能说明
...
<weconduct-graph src="../../../../assets/graphs/components/data/data-increment-variable.json" title="变量递增配置示例">如果图示加载失败，可以查看下方的示例配置。</weconduct-graph>
