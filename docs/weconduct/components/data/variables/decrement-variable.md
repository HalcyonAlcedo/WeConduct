...
资源键：`data.decrement_variable`　|　英文名：Decrement Variable
## 功能说明
...
<weconduct-graph src="../../../../assets/graphs/components/data/data-decrement-variable.json" title="变量递减配置示例">如果图示加载失败，可以查看下方的示例配置。</weconduct-graph>
