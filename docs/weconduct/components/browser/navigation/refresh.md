...
资源键：`browser.refresh`　|　英文名：Refresh
## 功能说明
...
<weconduct-graph src="../../../../assets/graphs/components/browser/browser-refresh.json" title="刷新配置示例">如果图示加载失败，可以查看下方的示例配置。</weconduct-graph>
