...
product: weconduct
version: 0.8.1
doc_id: component:browser.refresh
---
...
该节点属于“页面导航”。实现类型为 `core_atomic`，运行展开角色为 `action:refresh`。
...
<weconduct-graph src="../../../../assets/graphs/components/browser/browser-refresh.json" title="刷新配置示例">图示加载失败时，可阅读下方配置。</weconduct-graph>
