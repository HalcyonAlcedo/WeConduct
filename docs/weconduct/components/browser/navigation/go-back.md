...
该节点属于“页面导航”。实现类型为 `core_atomic`，运行展开角色为 `action:go_back`。
...
<weconduct-graph src="../../../../assets/graphs/components/browser/browser-go-back.json" title="后退配置示例">图示加载失败时，可阅读下方配置。</weconduct-graph>
