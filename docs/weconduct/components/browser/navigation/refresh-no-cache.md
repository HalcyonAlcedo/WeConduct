...
product: weconduct
version: 0.8.1
doc_id: component:browser.refresh_no_cache
---
...
该节点属于“页面导航”。实现类型为 `core_atomic`，运行展开角色为 `action:refresh_no_cache`。
...
<weconduct-graph src="../../../../assets/graphs/components/browser/browser-refresh-no-cache.json" title="无缓存刷新配置示例">图示加载失败时，可阅读下方配置。</weconduct-graph>
