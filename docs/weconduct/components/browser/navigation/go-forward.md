...
资源键：`browser.go_forward`　|　英文名：Go Forward
## 功能说明
...
<weconduct-graph src="../../../../assets/graphs/components/browser/browser-go-forward.json" title="前进配置示例">如果图示加载失败，可以查看下方的示例配置。</weconduct-graph>
