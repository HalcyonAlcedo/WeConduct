...
资源键：`browser.switch_to_frame`　|　英文名：Switch To Frame
## 功能说明
...
<weconduct-graph src="../../../../assets/graphs/components/browser/browser-switch-to-frame.json" title="切换到框架配置示例">如果图示加载失败，可以查看下方的示例配置。</weconduct-graph>
