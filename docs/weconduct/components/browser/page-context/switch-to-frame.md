...
product: weconduct
version: 0.8.1
doc_id: component:browser.switch_to_frame
---

# 切换到框架

资源键：`browser.switch_to_frame`  
英文名：Switch To Frame
...
该节点属于“页面上下文”。实现类型为 `core_atomic`，运行展开角色为 `action:switch_to_frame`。
...
<weconduct-graph src="../../../../assets/graphs/components/browser/browser-switch-to-frame.json" title="切换到框架配置示例">图示加载失败时，可阅读下方配置。</weconduct-graph>
