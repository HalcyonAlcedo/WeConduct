...
该节点属于“页面上下文”。实现类型为 `core_atomic`，运行展开角色为 `action:switch_to_parent_frame`。
...
<weconduct-graph src="../../../../assets/graphs/components/browser/browser-switch-to-parent-frame.json" title="切换到父框架配置示例">图示加载失败时，可阅读下方配置。</weconduct-graph>
