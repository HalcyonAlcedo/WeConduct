...
资源键：`browser.switch_to_default_content`　|　英文名：Switch To Default Content
## 功能说明
...
<weconduct-graph src="../../../../assets/graphs/components/browser/browser-switch-to-default-content.json" title="切换到默认内容配置示例">如果图示加载失败，可以查看下方的示例配置。</weconduct-graph>
