...
资源键：`browser.get_inner_html`　|　英文名：Get Inner HTML
## 功能说明
...
<weconduct-graph src="../../../../assets/graphs/components/browser/browser-get-inner-html.json" title="读取内部 HTML配置示例">如果图示加载失败，可以查看下方的示例配置。</weconduct-graph>
