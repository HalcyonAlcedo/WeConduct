...
product: weconduct
version: 0.8.1
doc_id: component:browser.get_html
---

# 读取 HTML

资源键：`browser.get_html`　|　英文名：Get HTML
## 功能说明
...
<weconduct-graph src="../../../../assets/graphs/components/browser/browser-get-html.json" title="读取 HTML配置示例">如果图示加载失败，可以查看下方的示例配置。</weconduct-graph>
