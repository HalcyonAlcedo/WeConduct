...
资源键：`browser.element_screenshot`　|　英文名：Element Screenshot
## 功能说明
...
需要开启浏览器截图和文件访问；需要开启浏览器执行器，并确保存在可用的页面目标。
...
<weconduct-graph src="../../../../assets/graphs/components/browser/browser-element-screenshot.json" title="元素截图配置示例">如果图示加载失败，可以查看下方的示例配置。</weconduct-graph>
