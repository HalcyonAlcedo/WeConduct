...
product: weconduct
version: 0.9.1
doc_id: component:browser.is_enabled
---

# 元素可用

资源键：`browser.is_enabled`　|　英文名：Is Enabled
## 功能说明
...
<weconduct-graph src="../../../../assets/graphs/components/browser/browser-is-enabled.json" title="元素可用配置示例">如果图示加载失败，可以查看下方的示例配置。</weconduct-graph>
