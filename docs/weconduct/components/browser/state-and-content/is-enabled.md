...
该节点属于“页面状态与内容”。实现类型为 `core_atomic`，运行展开角色为 `action:is_enabled`。
...
<weconduct-graph src="../../../../assets/graphs/components/browser/browser-is-enabled.json" title="元素可用配置示例">图示加载失败时，可阅读下方配置。</weconduct-graph>
