...
product: weconduct
version: 0.8.1
doc_id: component:browser.is_visible
---

# 元素可见

资源键：`browser.is_visible`　|　英文名：Is Visible
## 功能说明
...
<weconduct-graph src="../../../../assets/graphs/components/browser/browser-is-visible.json" title="元素可见配置示例">如果图示加载失败，可以查看下方的示例配置。</weconduct-graph>
