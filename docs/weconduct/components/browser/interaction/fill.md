...
product: weconduct
version: 0.8.1
doc_id: component:browser.fill
---

# 填入

资源键：`browser.fill`　|　英文名：Fill
## 功能说明
...
<weconduct-graph src="../../../../assets/graphs/components/browser/browser-fill.json" title="填入配置示例">如果图示加载失败，可以查看下方的示例配置。</weconduct-graph>
