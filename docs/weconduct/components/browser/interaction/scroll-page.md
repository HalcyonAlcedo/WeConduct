...
资源键：`browser.scroll_page`　|　英文名：Scroll Page
## 功能说明
...
<weconduct-graph src="../../../../assets/graphs/components/browser/browser-scroll-page.json" title="滚动页面配置示例">如果图示加载失败，可以查看下方的示例配置。</weconduct-graph>
