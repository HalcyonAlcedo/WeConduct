...
资源键：`browser.uncheck`　|　英文名：Uncheck
## 功能说明
...
<weconduct-graph src="../../../../assets/graphs/components/browser/browser-uncheck.json" title="取消勾选配置示例">如果图示加载失败，可以查看下方的示例配置。</weconduct-graph>
