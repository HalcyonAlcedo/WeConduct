...
product: weconduct
version: 0.8.1
doc_id: component:browser.click
---
...
该节点属于“页面交互”。实现类型为 `core_atomic`，运行展开角色为 `action:click`。
...
<weconduct-graph src="../../../../assets/graphs/components/browser/browser-click.json" title="点击配置示例">图示加载失败时，可阅读下方配置。</weconduct-graph>
