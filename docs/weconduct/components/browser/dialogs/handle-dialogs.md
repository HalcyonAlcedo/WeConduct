...
资源键：`dialog.handle_dialogs`　|　英文名：Handle Dialogs
## 功能说明
...
<weconduct-graph src="../../../../assets/graphs/components/browser/dialog-handle-dialogs.json" title="处理对话框配置示例">如果图示加载失败，可以查看下方的示例配置。</weconduct-graph>
