...
资源键：`dialog.switch_dialog_mode`　|　英文名：Switch Dialog Mode
## 功能说明
...
<weconduct-graph src="../../../../assets/graphs/components/browser/dialog-switch-dialog-mode.json" title="切换对话框模式配置示例">如果图示加载失败，可以查看下方的示例配置。</weconduct-graph>
