...
该节点属于“等待条件”。实现类型为 `core_atomic`，运行展开角色为 `action:wait_for_element`。
...
<weconduct-graph src="../../../../assets/graphs/components/browser/browser-wait-for-element.json" title="等待元素配置示例">图示加载失败时，可阅读下方配置。</weconduct-graph>
